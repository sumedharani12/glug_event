...
<div id="top" class="container-fluid text-center">
  ...
  <br>
    <div class="col-sm-12">
      <form action="/nadd" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="nname">Notes Name:</label>
          <input type="text" class="form-control" placeholder="Enter name" name="nname">
        </div>
        <div class="form-group">
          <label for="prname">Notes:</label>
